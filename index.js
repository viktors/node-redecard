...
var validators = {
  ...
  // TODO: shall it reformat user-supplied (possibly numeric) month and year?
  month: function(mm) {
    return ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'].indexOf(mm) != -1;
  },
  ...
  transactionType: (function() {
    var validCodes = [];
    for(var tt in TRANSACTION_TYPES) {
      if(TRANSACTION_TYPES.hasOwnProperty(tt)) {
        validCodes.push(TRANSACTION_TYPES[tt]);
      }
    }
...
module.exports = {
  ...
  getAuthorized: function(params, callback) {
    var paramDefs = {
